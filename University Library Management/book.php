	...
	<script type="text/javascript" src="js/nbook.js"></script>
 ...
 ?>
	...
	<li class="current"><a href="book.php">Books</a></li>
	...
	<div id="site_content">
		...
		<form action="book.php" method="post" title="Sort by department" style="margin-bottom:30px;">
			...
			?>
				<tr OnMouseOut="this.style.background='#F5DEB3'" OnMouseOver="this.style.background='#87CEFA'" style="background: 	#F5DEB3;" title="Click for view all books of <?php echo $arr['book_name']; ?>">
					...
					<td style="width:250px;">
						<a href="book.php?open_book=book&book_id=<?php echo $arr['book_id']; ?>" style="text-decoration:none;" >
