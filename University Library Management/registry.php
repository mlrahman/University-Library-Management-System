 ...
 ?>
 	<script type="text/javascript" src="js/nuser_registry.js"></script>
	
	<li><a href="index.php">Home</a></li>
	<li><a href="book.php">Books</a></li>
	<li class="current"><a href="registry.php">Registry</a></li>
	</ul>
        </div><!--close menubar-->	
      </nav>
    </header>
	...
	<div id="site_content">
		...
		<form action="registry.php" method="post"  style="margin-bottom:30px;">
			...
			<input type="text" name="user_registry_id" autocomplete="off" id="id" onkeyup="autocomplet()"  placeholder="    Search for user...." style="float:left;width:250px;border-radius:5px;margin-left:262px;" title="Enter user NEUB ID or name." >
			...
			?>
				<tr OnMouseOut="this.style.background='#F5DEB3'" OnMouseOver="this.style.background='#87CEFA'" style="background: 	#F5DEB3;" title="Click for view this registry details..">
					...
					<td style="width:260px;">
						<a href="registry.php?open_registry=book&take_id=<?php echo $arr['take_id']; ?>" style="text-decoration:none;" >
